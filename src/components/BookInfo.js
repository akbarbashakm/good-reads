  ...
  render() {
    ...
    return (
      <div className="row col-lg-12">
        <Button className="btn btn-primary" onClickAction={this.props.collapseBook} buttonName={"<< Go Back"} />

        <h3 className="col-lg-12 mb-3 mt-3">{bookData.best_book.title}</h3>
        <Card className="col-lg-2 col-sm-4">
          <img
            ...
            alt="book cover"
          />
          <Text widthSize={'90%'}>{`By: ${bookData.best_book.author.name}`}</Text>
          <Text widthSize={'90%'}>{`Avg. Rating: ${bookData.average_rating}`}</Text>
        </Card>
